 ...
 */
module.exports = {
    subscribedCustomers: function subscribedCustomers(parameters) {
        ...
        var CustomObjectCount = profilesIterator.getCount();
        var CustomObjectData = profilesIterator.asList(0, CustomObjectCount);
        ...
        for (var i = 0; i < CustomObjectData.length; i++) {
            ...
            xsw.writeCharacters("\n");
            xsw.writeCharacters(CustomObjectData[i].email);
            xsw.writeCharacters("\n");
            xsw.writeEndElement();
            xsw.writeCharacters("\n");
        }
